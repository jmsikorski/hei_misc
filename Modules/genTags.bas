...
Function getPath() As String
    ...
    End If
    If xStrPath = "" Then Exit Function
    getPath = xStrPath
End Function
...
'UpdateByExtendoffice20160623
    ...
    Do While xFile <> ""
        ...
        wb.Activate
        wb.Worksheets("Lead Files").Select
        list.Select
        ActiveCell.Value = xStrPath & "\" & xFile
...
'    Next i
    ...
    i = 1
    Do While sheetExists("LEAD " & i)
        wb.Worksheets("LEAD " & i).Delete
        i = i + 1
    Loop
    Application.DisplayAlerts = True
